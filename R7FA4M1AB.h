...
#ifndef R7FA4M1AB_H      /* ToDo: replace '<Device>' with your device name */
#define R7FA4M1AB_H
...
#include "system_R7FA4M1AB.h"                    /* System Header */
...
/* R7FA4M1_TMR LOAD Register Definitions */
#define R7FA4M1_TMR_LOAD_Pos              0
#define R7FA4M1_TMR_LOAD_Msk             (0xFFFFFFFFUL /*<< R7FA4M1_TMR_LOAD_Pos*/)

/* R7FA4M1_TMR VALUE Register Definitions */
#define R7FA4M1_TMR_VALUE_Pos             0
#define R7FA4M1_TMR_VALUE_Msk            (0xFFFFFFFFUL /*<< R7FA4M1_TMR_VALUE_Pos*/)

/* R7FA4M1_TMR CONTROL Register Definitions */
#define R7FA4M1_TMR_CONTROL_SIZE_Pos      1
#define R7FA4M1_TMR_CONTROL_SIZE_Msk     (1UL << R7FA4M1_TMR_CONTROL_SIZE_Pos)

#define R7FA4M1_TMR_CONTROL_ONESHOT_Pos   0
#define R7FA4M1_TMR_CONTROL_ONESHOT_Msk  (1UL /*<< R7FA4M1_TMR_CONTROL_ONESHOT_Pos*/)
...
#define R7FA4M1_FLASH_BASE       (0x00000000UL)                              /* (FLASH     ) Base Address */
#define R7FA4M1_SRAM_BASE        (0x20000000UL)                              /* (SRAM      ) Base Address */
#define R7FA4M1_PERIPH_BASE      (0x40000000UL)                              /* (Peripheral) Base Address */

/* Peripheral memory map */
#define R7FA4M1_TIM0_BASE         (R7FA4M1_PERIPH_BASE)          /* (Timer0    ) Base Address */
#define R7FA4M1_TIM1_BASE         (R7FA4M1_PERIPH_BASE + 0x0800) /* (Timer1    ) Base Address */
#define R7FA4M1_TIM2_BASE         (R7FA4M1_PERIPH_BASE + 0x1000) /* (Timer2    ) Base Address */
...
#define R7FA4M1_TIM0        ((R7FA4M1_TMR_TypeDef *) R7FA4M1TIM0_BASE)
#define R7FA4M1_TIM1        ((R7FA4M1_TMR_TypeDef *) R7FA4M1TIM0_BASE)
#define R7FA4M1_TIM2        ((R7FA4M1_TMR_TypeDef *) R7FA4M1TIM0_BASE)
